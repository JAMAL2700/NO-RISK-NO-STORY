...
const MUSTER_KATEGORIEN = [
  ...
  },
  {
    ...
    patterns: [
      ...
      { name: "Pennant (Bullish)", desc: "Mini-Dreieck nach starkem Anstieg — Pole steil hoch, dann enger werdende Konsolidierung, dann Ausbruch.", svg: lineSvg([[5, 55], [22, 10], [31, 27], [40, 15], [49, 23], [58, 17], [67, 21], [82, 8], [95, 2]]) },
      { name: "Pennant (Bearish)", desc: "Mini-Dreieck nach starkem Fall — Pole steil runter, dann enger werdende Konsolidierung, dann Ausbruch.", svg: lineSvg([[5, 5], [22, 50], [31, 33], [40, 45], [49, 37], [58, 43], [67, 39], [82, 52], [95, 58]]) },
      { name: "Rising Three Methods", desc: "Bullisches Fortsetzungsmuster — starker Anstieg, kleine Verschnaufpause mit 3 leichten Rücksetzern, dann Trend setzt sich fort.", svg: lineSvg([[5, 52], [20, 12], [36, 22], [50, 15], [64, 22], [95, 4]]) },
      { name: "Falling Three Methods", desc: "Bearishes Fortsetzungsmuster — starker Fall, kleine Verschnaufpause mit 3 leichten Erholungen, dann Trend setzt sich fort.", svg: lineSvg([[5, 8], [20, 48], [36, 38], [50, 45], [64, 38], [95, 56]]) },
    ],
  },
  {
    title: "Umkehrformationen",
    patterns: [
      { name: "Island Reversal", desc: "Abrupte Umkehr durch Gaps auf beiden Seiten einer kleinen Konsolidierung, wie eine isolierte Insel im Chart.", svg: lineSvg([[5, 50], [22, 18], [34, 18], [46, 15], [58, 18], [70, 18], [82, 50], [95, 56]]) },
      ...
      { name: "Bump and Run Reversal", desc: "Übertreibung — unnatürlich steiler Anstieg (der 'Bump'), danach Umkehr, die unter die ursprüngliche Trendlinie fällt.", svg: lineSvg([[5, 48], [25, 38], [45, 6], [62, 22], [78, 40], [95, 55]]) },
      { name: "Diamond Top", desc: "Komplexes Umkehrmuster (bearish) — erst breiter werdende, dann enger werdende Schwankungen, danach Abwärtsbruch.", svg: lineSvg([[5, 30], [17, 22], [29, 38], [41, 10], [53, 48], [65, 20], [77, 35], [86, 28], [95, 48]]) },
      { name: "Diamond Bottom", desc: "Komplexes Umkehrmuster (bullish), Spiegelbild vom Diamond Top, danach Aufwärtsbruch.", svg: lineSvg([[5, 30], [17, 38], [29, 22], [41, 50], [53, 12], [65, 40], [77, 25], [86, 32], [95, 12]]) },
    ],
  },
  {
    title: "Harmonic Patterns",
    intro: "Trendwendemuster nach Fibonacci-Verhältnissen (X-A-B-C-D-Zickzack) — fortgeschritten, eher was für später. Diagramme hier sind vereinfacht, die genauen Ratios unterscheiden sich pro Pattern.",
    patterns: [
      { name: "Gartley Pattern", desc: "Trendwendemuster nach klassischen Fibonacci-Zonen (X-A-B-C-D).", svg: lineSvg([[5, 50], [24, 10], [40, 32], [58, 16], [75, 40], [95, 8]]) },
      { name: "Bat Pattern", desc: "Harmonisches Muster mit engeren Fibonacci-Zonen als Gartley — D liegt näher an X.", svg: lineSvg([[5, 50], [24, 8], [40, 36], [58, 14], [75, 42], [95, 12]]) },
      { name: "Butterfly Pattern", desc: "Erweiterte Umkehrformation — D geht über den Ausgangspunkt X hinaus.", svg: lineSvg([[5, 42], [24, 6], [40, 28], [58, 10], [78, 44], [95, 2]]) },
      { name: "Crab Pattern", desc: "Tiefere Fibonacci-Erweiterung als Butterfly — D geht noch weiter über X hinaus.", svg: lineSvg([[5, 42], [24, 8], [40, 24], [58, 6], [82, 50], [95, 1]]) },
      { name: "Shark Pattern", desc: "Neueres harmonisches Muster mit eigenen Fibonacci-Ratios, etwas asymmetrischer als die anderen.", svg: lineSvg([[5, 38], [20, 14], [35, 28], [50, 8], [70, 46], [95, 18]]) },
    ],
  },
];
